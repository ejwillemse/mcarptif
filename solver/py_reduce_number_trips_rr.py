...
from py_solution_builders_rr import build_CARP_list
from py_solution_builders_rr import build_CLARPIF_list
from py_solution_builders_rr import build_CARP_dict_from_list
from py_solution_builders_rr import build_CLARPIF_dict_from_list
from py_display_solution_rr import display_solution_stats 
from py_route_modifier_rr import insert_multiple_arcs
...
class Reduce_Trips(object):
    ...
    def reduce_carp_routes(self, solution_lists, insert_depots=True):
        ...
        while reduction:
            ...
            new_deadhead = []
            new_costs = []
            for j in xrange(reduction, nRoutes):
            ...
            if insert_depots:
                for k in xrange(len(solution_lists_new[0])):
